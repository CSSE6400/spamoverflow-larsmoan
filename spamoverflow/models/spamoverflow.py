...
class Email(db.Model):
    ...
    status = db.Column(
        ENUM("pending", "scanned", "failed", name="email_status"), default="pending"
    ...
    domains = relationship(
        "Domain", back_populates="email", cascade="all, delete-orphan"
    )
...
class Customer(db.Model):
    ...
    emails = relationship(
        "Email", back_populates="customer", cascade="all, delete-orphan"
    )
